...
`# TODO` 블록의 설정 키들을 채워주세요. 각 키에 대한 설명은 주석을 참고하세요.
...
`spark.sql.shuffle.partitions`가 **200**으로 설정되어 있습니다. 이 상태로 실행하면 시나리오 04가 실패합니다. 왜 실패하는지 이해하고 적절한 값으로 변경하여 통과시켜 보세요.
